...
#########################################
def mainFn():   #1.  The main function will take one argument which is a text string indicating where the user wishes to write the file.
...
#  writePictureTo(pic,)   #12.	It then writes the image to disk as the user indicated in the call to the main function  
################################################################### 
def subFn3(pic):
