...
def mainFn(path):  
  ...
  height,width=getHeight(file),getWidth(file)        #get height and width     
  ...
  explore(canvas)                                    #explore the canvas
  writePictureTo(canvas,path)                        #save the canvas to hard driver
########################################################################
...
#copy picture to canvas with upside down            
