...
int main()
{
  ...
  do
  {
     ...
     if(choice=='2')
     {
       ...
       {
          cout<<YEL<<"There are "<<ListPtr->size()<<" accounts in the system."<<endl;
          PrintSum();
          cout<<"Input 1-"<<ListPtr->size()<<" to print out details of that account."<<endl;
          cout<<"Input 'a' to print out details of all accounts."<<endl;
          cout<<"Input 'n' to go back to the main menu."<<endl;
          cin>>input;
          do
          {
              if(input=="n"||input=="N")
...
void PrintSum()
{
  ...
  for(int i=0;i<vecSize;++i)
  {
        ...
        cout<<" "<<i+1<<"    "<<setw(20)<<name<<setw(11)<<List[i].getBala()<<endl;
  }
  cout<<"----------------------------------------------\n";
}
