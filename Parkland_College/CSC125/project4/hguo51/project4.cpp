...
int main()
{
  ...
  //debugging
  //add some managers salepersons Insurance sales
  //and assign them to each others properly
  ...
  while(1)
  {
    ...
    else if (choice=="2")
    {
      if(allm.size()==0)
      {
        ...
        cout<<"Please creat at least one manager.\n"<<RESET;
      }
      else
      {
        string input="";
    ...
    else if (choice=="3")
    {
        ...
        {
          cout<<RED<<"\nNo manager in the system. ";
          cout<<"Please creat at least one manager."<<RESET<<endl;
        }
        //stiuation for no one saleperson in the system
        else if(alls.size()==00)
        {
          cout<<RED<<"\nNo salesperson in the system. ";
          cout<<"Please creat at least one salesperson."<<RESET<<endl;
        }
    ...
    else if (choice=="4")
    {
        ...
        while(1)
        {
          ...
          if(input=="1")
          {
            ...
            listAllE(spos,alls);
            cout<<" There are "<<GRN<<allm.size()+alls.size()<<RESET<<" employees in the system.\n";
          }
          //print out all sales
          else  if(input=="2")
          {
          ...
          else if(input=="3")
          {
              ...
              if(allm.size()==0&&alls.size()==0)
              {
                cout<<"There is no record for any employee in the system.\n";
              }
          }
          ...
          else if(input=="4")
          {
            ...
            {
              cout<<RED<<"\nNo salesperson in the system. ";
              cout<<"Please creat at least one salesperson.\n"<<RESET<<endl;
            }
            string assign="";
            //loop to choose which employee to print
            while(allm.size()>0&&alls.size()>0)
            {
          ...
          else if(input=="5")
          {
            ...
            {
              cout<<RED<<"\nNo manager in the system. ";
              cout<<"Please creat at least one manager."<<RESET<<endl<<endl;
            }
            //print the all sales for a team
            else{teamSales(allm,alls);}
          }
